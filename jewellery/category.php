  ...
  <div class="container">
    ...
    <div class="product-grid">
      ...
      <div class="product-card">
        ...
        <a href="cart.php?add=<?= $p['id'] ?>" class="product-cart-btn" style="text-align:center; display:block; text-decoration:none;"><i class="fas fa-shopping-bag"></i> Add to Cart</a>
      </div>
      <?php endforeach; ?>
    </div>
